...
window.VOCHINO_CONFIG = {
  API_BASE: 'https://vochino-telegram-bot-kjb8.onrender.com',
  API_ENDPOINT_DASHBOARD: '/api/dashboard',

  SOCIAL_LINKS: { telegram: 'https://t.me/Vochino01', instagram: '#', youtube: '#', store: '#' },
  ...
  VOUCHER_TYPES: [
    { name: 'یو ووچر', icon: '💎' },
    { name: 'هات ووچر', icon: '🔥' },
    { name: 'پرمیوم ووچر', icon: '👑' },
    { name: 'پی‌اس ووچر', icon: '🎮' },
    { name: 'پرفکت‌مانی', icon: '💠' },
    { name: 'دلار', icon: '💵' },
    { name: 'ترون', icon: '🔺' },
    { name: 'تون', icon: '💎' }
  ],
